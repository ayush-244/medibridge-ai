...
│       │   │   │   ├── HospitalsView.tsx
│       │   │   │   ├── HospitalCard.tsx
│       │   │   │   ├── HospitalDetailSheet.tsx
│       │   │   │   ├── CreateHospitalDialog.tsx
│       │   │   │   ├── EditHospitalDialog.tsx
│       │   │   │   └── UpdateBedsDialog.tsx
│       │   │   ├── hooks/
│       │   │   ├── services/
│       │   │   ├── types/
│       │   │   ├── utils/
...
│       │   ├── referrals/
│       │   │   ├── components/
│       │   │   │   ├── CreateReferralDialog.tsx
│       │   │   │   └── ReferralForm.tsx
│       │   │   ├── hooks/
│       │   │   │   └── useCreateReferral.ts
│       │   │   ├── services/
│       │   │   ├── types/
│       │   │   ├── utils/
│       │   │   └── index.ts
...
| Area             | Endpoints                                                                             |
| ---------------- | ------------------------------------------------------------------------------------- |
| Auth             | `GET /auth/admin`, `GET /auth/test`                                                   |
|                  |                                                                                       |
| Doctors          | `GET /doctors/hospital/:hospitalId`                                                   |
|                  |                                                                                       |
...
# Phase 9 — Core Operations Integration
...
- Role-based access:
  ...
  - HOSPITAL_ADMIN → Own hospital users
...
## Phase 10 — Google Maps & Location Intelligence
...
## Phase 11 — Smart Referral Engine
...
## Phase 13 — Emergency Referral Automation
...
| `/settings``/users``/admin/audit-logs` | Profile & PreferencesUsers ManagementAudit Logs | All authenticated rolesSuper Admin, Hospital AdminSuper Admin |
